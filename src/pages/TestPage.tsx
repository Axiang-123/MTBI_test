  ...
  const handlePrev = () => {
    if (currentQuestionIndex > 0) {
      ...
      if (!answers[prevQuestion.id]) {
        useTestStore.getState().setAnswer(prevQuestion.id, 0);
      }
      ...
      <div className="max-w-3xl mx-auto">
            ...
            >
              {[1, 2, 3, 4, 5].map((score) => (
                <motion.button
                  ...
                  className={`w-full text-left py-3 px-4 rounded-lg border transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${currentAnswer === score
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className={`font-medium ${currentAnswer === score ? 'text-blue-700' : 'text-gray-700'}`}>
        ...
        <div className="flex justify-center gap-4">
          <button
            ...
            className={`px-6 py-3 rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${currentQuestionIndex === 0
